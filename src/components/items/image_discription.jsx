...
function Image({ src, desc, setShowImage }) {
    return (
        <div className={`fixed inset-0 z-10  bg-white/30`} onClick={() => { setShowImage(false) }}>
            ...
            <div class="relative border-3 mt-24 border-black shadow-[12px_12px_0px_#000000] overflow-hidden transition-all ease-in-out duration-300 transform -translate-x-6 -translate-y-6 bg-blue-900 w-fit h-fit p-2 self-center justify-self-center rounded-2xl text-right">
                <div >
